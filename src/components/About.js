      ...
      <div className="about-grid-container">
        <div className="about-container">
          ...
          <div className="information-text-container">
            ...
            <p className="information">
              I graduated in a bootcamp.
              I pursued web development as it is a great opportunity for me to do what I love:
        ...
        <div className="techstacks-container">
          <div className="techstacks-border">
            <div className="techstacks-grid">
              <p className="techstacks-text">
              ...
              <p className="t9">HTML</p>
              <p className="t10">CSS</p>
              <p className="t11">Javascript</p>
              <p className="t12">Bootstrap</p>
              <p className="t13">ReactJS</p>
              <p className="t14">NodeJS</p>
              <p className="t15">ExpressJS</p>
              <p className="t16">MongoDB</p>
            </div>
          </div>
        </div>
        <div className="resume-container">
          <div className="downloadResume" onClick={downloadResume}>
            <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" fill="currentColor" className="bi bi-download download-icon" viewBox="0 0 16 16">
        ...
        <div className="linkedin-container">
          <a className="linkedin" href="https://www.linkedin.com/in/reydalin-barroso-2a866a24b/" target="_blank">
        ...
        <div className="facebook-container">
          <a className="facebook" href="https://www.facebook.com/rererereyds/" target="_blank">
        ...
        <div className="instagram-container">
          <a className="instagram" href="https://www.instagram.com/rererereyds/" target="_blank">
        ...
        <div className="reyda-image-container">
          <img
            className="reyda-image"
